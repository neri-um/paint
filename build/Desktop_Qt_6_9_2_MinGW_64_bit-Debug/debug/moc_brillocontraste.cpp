...
namespace {
struct qt_meta_tag_ZN15brillocontrasteE_t {};
} // unnamed namespace

template <> constexpr inline auto brillocontraste::qt_create_metaobjectdata<qt_meta_tag_ZN15brillocontrasteE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<brillocontraste, qt_meta_tag_ZN15brillocontrasteE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject brillocontraste::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15brillocontrasteE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15brillocontrasteE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN15brillocontrasteE_t>.metaTypes,
    nullptr
} };
...
void *brillocontraste::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN15brillocontrasteE_t>.strings))
