...
namespace {
struct qt_meta_tag_ZN9MatSatLumE_t {};
} // unnamed namespace

template <> constexpr inline auto MatSatLum::qt_create_metaobjectdata<qt_meta_tag_ZN9MatSatLumE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_MatSatLum_accepted'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_MatSatLum_rejected'
    ...
    return QtMocHelpers::metaObjectData<MatSatLum, qt_meta_tag_ZN9MatSatLumE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject MatSatLum::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MatSatLumE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MatSatLumE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9MatSatLumE_t>.metaTypes,
    nullptr
} };
...
void *MatSatLum::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9MatSatLumE_t>.strings))
