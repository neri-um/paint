...
namespace {
struct qt_meta_tag_ZN12mediadevideoE_t {};
} // unnamed namespace

template <> constexpr inline auto mediadevideo::qt_create_metaobjectdata<qt_meta_tag_ZN12mediadevideoE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_mediadevideo_destroyed'
    ...
    return QtMocHelpers::metaObjectData<mediadevideo, qt_meta_tag_ZN12mediadevideoE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject mediadevideo::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12mediadevideoE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12mediadevideoE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN12mediadevideoE_t>.metaTypes,
    nullptr
} };
...
void *mediadevideo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN12mediadevideoE_t>.strings))
