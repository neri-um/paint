...
namespace {
struct qt_meta_tag_ZN14mediaponderadaE_t {};
} // unnamed namespace

template <> constexpr inline auto mediaponderada::qt_create_metaobjectdata<qt_meta_tag_ZN14mediaponderadaE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_mediaponderada_accepted'
    ...
    return QtMocHelpers::metaObjectData<mediaponderada, qt_meta_tag_ZN14mediaponderadaE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject mediaponderada::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14mediaponderadaE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14mediaponderadaE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14mediaponderadaE_t>.metaTypes,
    nullptr
} };
...
void *mediaponderada::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14mediaponderadaE_t>.strings))
